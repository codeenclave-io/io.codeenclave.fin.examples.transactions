...
import io.codeenclave.fin.examples.service.transactions.controllers.MyMathServer
import io.codeenclave.fin.examples.service.transactions.controllers.MyMathsApp
import io.codeenclave.fin.examples.service.transactions.Matchers.answerShouldBe
...
object Matchers {
    fun Response.answerShouldBe(expected: Int) {
        assertThat(this, hasStatus(Status.OK).and(hasBody(expected.toString())))
    }
}
